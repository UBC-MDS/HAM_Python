...
compare_model(feature, methods=c("CC","IMP")): 
	...
	Arguments:
     - feature -- a vector or matrix of a specified feature from the original dataset 
     containing missing values that needs to be imputed.
     - methods -- the methods that users want to compare (default: c("CC","IMP"))
    ...
    Output: 
    - a summary table comparing the summary statistics: 
